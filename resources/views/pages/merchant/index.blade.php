                                            ...
                                            @if(count($brands))
                                                <select name="brand_id" class="form-control" id="brand_id">
                                                    ...
                                                    @foreach($brands as $brand)
                                                        <option @if(request()->brand_id == $brand->id) selected @endif value="{{ $brand->id }}">{{ $brand->name }}</option>
                                                    @endforeach
                                                </select>
                                            @endif
                                        </th>
...
{{--                                            <input value="{{ request()->account_number }}" type="text" placeholder="@lang('cruds.account.account_number')" class="clear-class form-control" name="account_number">--}}
                                        ...
                                        <th>
                                            <select name="status" class="form-control">
                                                <option></option>
                                                <option @if(isset(request()->status) and request()->status ==1) selected @endif value="1">@lang('cruds.status.1')</option>
                                                <option @if(isset(request()->status) and request()->status ==0) selected @endif value="0">@lang('cruds.status.0')</option>
                                            </select>
                                        </th>
                                        <th>
