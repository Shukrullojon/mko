...
//    }
    ...
    public function view(): View
    {
        ...
        if ($this->fromDate) {
            $transactions = $transactions->whereDate('transaction_accounts.updated_at', '>=', $this->fromDate);
        }

        if ($this->toDate) {
            $transactions = $transactions->whereDate('transaction_accounts.updated_at', '<=', $this->toDate);
        }
